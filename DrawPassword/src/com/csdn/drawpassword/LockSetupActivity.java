...
import com.csdn.drawpassword.axml.LockPatternView;
import com.csdn.drawpassword.axml.LockPatternView.Cell;
import com.csdn.drawpassword.axml.LockPatternView.DisplayMode;
    ...
    public void onClick(View v) {
        ...
        case R.id.right_btn:
            if (step == STEP_2) {
                ...
                SharedPreferences preferences = getSharedPreferences("paeweas" ,MODE_PRIVATE);
                preferences
                        .edit()
                        .putString("paeweas",
