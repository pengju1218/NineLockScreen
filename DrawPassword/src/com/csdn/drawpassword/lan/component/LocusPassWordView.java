package com.csdn.drawpassword.lan.component;
...
import com.csdn.drawpassword.lan.util.MathUtil;
import com.csdn.drawpassword.lan.util.Point;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (isFinish) {
			if (this.sPoints.size() == 1) {
				...
				error();
				clearPassword();
				//Toast.makeText(this.getContext(), "password too short or too long, cannot be saved!", Toast.LENGTH_SHORT).show();
