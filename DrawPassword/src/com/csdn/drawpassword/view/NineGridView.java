...
//path移动至当前圆点坐标  
    ...
    private float patternMargin = 55;//九宫格距离边界距离
    private float bigCircleRadius = 50;//外圆半径
    private float smallCircleRadius = 15;//内圆半径
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text, width / 2, height / 9, mPaintText);
/**
 * 绘制九个圆点图案
 */
   ...
   // 本篇文章来源于源码库(www.aspku.com),转载请注明出处 原文链接：http://www.aspku.com/kaifa/android/69397.html